...
module.exports = {
  ...
  DB_CONNECTION: process.env.DB_CONNECTION || 'postgresql://localhost:5432/flippa',
  GCS_BUCKET: process.env.GCS_BUCKET || 'flippa-dev',
  GCS_PROJECT_ID: process.env.GCS_PROJECT_ID || 'flippa-35259',
  GOOGLE_APPLICATION_CREDENTIALS: process.env.GOOGLE_APPLICATION_CREDENTIALS || path.resolve(`${__dirname}/gcs-keyfile.json`)
}
